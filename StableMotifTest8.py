...
print()
print()
print("AN OBSERVATION AND EXAMPLE")
print("--------------------------")
print("Note that the merge method finds several control sets of size two.")
print("The history method finds only sets of size three.")
print("In these cases, two of the driver nodes within one or more stable")
print("motifs serve as external drivers of another stable motif.")
print("For example, consider {'TBET': 1, 'SPHK1': 0, 'IL2RBT': 1} and ")
print("{'SPHK1': 0, 'IL2RBT': 1} from the history and merge methods, respectively.")
print("Here, {'SPHK1': 0, 'IL2RBT': 1} drives TBET=1 and thus the motif it drives.")
print("The logical domain of influence of {'SPHK1': 0, 'IL2RBT': 1} is:")
print()
print(sm.DomainOfInfluence.logical_domain_of_influence({'SPHK1': 0, 'IL2RBT': 1},primes)[0])
print()
print("Note that this contains TBET=1.")
